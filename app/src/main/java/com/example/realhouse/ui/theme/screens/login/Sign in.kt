package com.example.realhouse.ui.theme.screens.login
...
fun Login(navController: NavHostController) {
    ...
    Column(modifier = Modifier.run {
        ...
        }, modifier = Modifier.size(width = 350.dp, height = 35.dp),colors = ButtonDefaults.buttonColors(Blackmatte)) {
            Text(color = Color.White, text = "Log In")
        }
        Spacer(modifier = Modifier.height(20.dp))
